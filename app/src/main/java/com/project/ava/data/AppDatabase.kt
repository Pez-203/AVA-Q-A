...
abstract class AppDatabase : RoomDatabase() {
    ...
    private class SeedCallback : Callback() {
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            db.execSQL("INSERT INTO questions (categoryId, questionText, answerText) VALUES (1," +
            ...
            db.execSQL("INSERT INTO questions (categoryId, questionText, answerText) VALUES (2," +
